    ...
    ?>
        ...
        <a href="#" class="navbar-brand animate__animated animate__bounce head-logo margin-add mt-5 pl-3 ml-5"><h1 class=""><img src="./assets/images/logo.svg" alt="logo.svg" style="background-color: #021859;"></h1></a>
           ...
           <div class="container margin-add pt-5 ml-5">
                 ...
                 <div class="clouds">
                    <img class="absolute hvr-pulse-grow  mix-blend star-img image-fluid" src="./assets/images/star.svg" alt="star.svg">
                    <img class="absolute animate__animated animate__jackInTheBox  mix-blend moon-img image-fluid" src="./assets/images/moon.svg" alt="moon.svg">
                    <img class="absolute hvr-pulse-grow  mix-blend cloud-one image-fluid" src="./assets/images/cloud-small.svg" alt="cloud.svg">
                    <img class="absolute hvr-pulse-grow  mix-blend cloud-two image-fluid" src="./assets/images/cloud-2.svg" alt="cloud.svg">
                    <img class="absolute hvr-pulse-grow  mix-blend cloud-three image-fluid" src="./assets/images/cloud2.svg" alt="cloud.svg">
                 </div>
                  </div>
            <div class="container  margin-add ml-5 text-pack">
                ...
                <span class="update margin-add pl-3 ml-5">Please Send Me The Latest Update About DreamLand</span> <br> <br> <br>
            ...
            <div class="container-fluid break-sec mt-0 pt-0">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="jumbotron">
                            <span class="span-logo">
     ...
     <center>   <div class="heading pt-5">   
                 <h2 class="head-1">What Can You Do With Dreamland</h2> <br>
            ...
            <div class="container-fluid ml-5 ">
                <div class="row ml-5 pt-5">
                    <div class=" hvr-wobble-horizontal col-md-4"> <a data-fancybox="gallery" href="./assets/images/placeholder360x640.png"><img src="./assets/images/placeholder266x536.png"></a></div>
                    <div class=" hvr-wobble-horizontal col-md-4"><a data-fancybox="gallery" href="./assets/images/placeholder360x640.png"><img src="./assets/images/placeholder266x536.png"></a></div>
                    <div class=" hvr-wobble-horizontal col-md-4"><a data-fancybox="gallery" href="./assets/images/placeholder360x640.png"><img src="./assets/images/placeholder266x536.png"></a></div>
                </div>
             ...
             <div class="form-words mr-5">
             <span class="text-center">Your Days Of Nightmares And Dreams</span>
             <p class="text-center">Uncertainities Are Almost Over</p>
